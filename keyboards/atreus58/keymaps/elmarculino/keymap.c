...
enum layer_number  { _QWERTY, _LOWER, _RAISE, _ADJUST, _COLEMAK };
 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  LCTL_ESC, LCTL_A, LALT_S,  LSFT_D,  LGUI_F,  KC_G,                     KC_H,    RGUI_J,  RSFT_K,  RALT_L,  RCTL_SC, KC_QUOT, \
 ...
 * |      |      |      | CAPS |      |      |-------|    |-------| PScr |   _  |   +  |   {  |   }  |   |  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | / Space /       \Enter \  | Del  |RAISE | RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, KC_CAPS, _______, _______, _______, _______, KC_PSCR, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
                             _______, _______, _______, _______, KC_BSLASH, KC_DEL, _______, _______\
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      | QWER | CLMK |      |      |      |                    |      |      |      |      |      |      |
...
[_RAISE] = LAYOUT( \
  _______, LY_QWER, LY_CLMK, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, \
